...
tellraw @s [{"text": " - "},{"text": "[CC扩展...]\n","bold": true,"color": "light_purple","clickEvent": {"action": "run_command","value": "/function cc:main"}}]
tellraw @s [{"text": " - "},{"text": "[实验性内容...]","bold": true,"color": "gold","clickEvent": {"action":"run_command","value": "/function cod:debug/main"}}]